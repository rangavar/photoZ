...
python2.7 estimateMulticore.py #produce multiple copies of the core (50 copies in this setting) to make it possible to run the code on 50 cores parallel
